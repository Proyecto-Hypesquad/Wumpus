...
export interface CommonQuery {
	insertHechizo(userId: string, hechizo: Hechizo): Promise<unknown>;
	insertHechizo2(userId: string): Promise<unknown>;
	updateHechizo(userId: string, hechizoId: string, hechizo: Hechizo): Promise<unknown>;
	fetchHechizosFromUser(userId: string): Promise<Hechizos[]>;
}
...
export class JsonProvider extends Provider {
	...
	public update(table: string, entry: string, data: object): Promise<unknown>;
	public replace(table: string, entry: string, data: object): Promise<unknown>;
